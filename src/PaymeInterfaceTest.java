 ...
 */
/**
 * PaymeInterfaceTest class provides the main method to test classes
 * @author Si Wang
...
paymeObjects[5] = new BasePlusCommissionProgrammer("Si","Wang","102-34-5888",1200.00,0.04,720.00);
 ...
 for (Payme currentPayme : paymeObjects) {
    ...
    if (currentPayme instanceof BasePlusCommissionProgrammer) {
       // downcast Payme reference to BasePlusCommissioProgrammer reference in order to get the base salary in Class Programmer
